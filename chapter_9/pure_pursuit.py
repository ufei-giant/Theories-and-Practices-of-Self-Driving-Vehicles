...
Kp = 1.0  # Speed controller coefficient
dt = 0.1  # Time interval (s)
L = 2.9  # Vehicle wheelbase (m)
...
def calc_target_index(state, cx, cy):
    # Search for the closest waypoint
...
def main():
    ...
    T = 100.0  # Maximum simulation time

    # Set the accident status of the vehicle
